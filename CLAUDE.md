...
- `clockify-plugin/commands/clockify.md` — comando `/clockify` (status / verificar conexão; mostra manual rápido após conectar).
- `clockify-plugin/skills/clockify-tracking/references/manual-rapido.md` — roteiro do manual de boas-vindas (lido por `/clockify` e pela 1ª conexão do `/clockify-tracking`; apresentado na língua da pessoa).
