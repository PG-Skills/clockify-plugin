#!/usr/bin/env python3
"""Instala/atualiza a CLI clockify-plugin com guard de versão. Roda em SessionStart.
...
def _log(msg: str) -> None:
    print(f"clockify-plugin: {msg}", file=sys.stderr)
...
def main() -> int:
    ...
    if not root:
        return 0
    data = os.environ.get("CLAUDE_PLUGIN_DATA") or str(Path.home() / ".cache" / "clockify-plugin")
